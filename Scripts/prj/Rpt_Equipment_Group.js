$(document).ready(function () {
    ...
    function InsertTotalAfterSorted() {
        ...
        $.ajax({
            dataType: 'json',
            url: $.AppConfigOptions.baseurl + 'Rpt_Equipment_Group/GetSumData',
            type: "post",
            ...
            success: function (data) {
                ...
                if (data[0] != '' && data[1] != '' && data[2] != '' && data[3] != '' && data[4] != '') {
                    ...
                    var content = '<tr data-index="9999"> \
                           <td class="dou-field-Dnickname">總計：</td> \
                           <td class="dou-field-PC" style="text-align: right; ">'+ data[0] + '</td> \
                           <td class="dou-field-NB" style="text-align: right; ">'+ data[1] + '</td> \
                           <td class="dou-field-PAD" style="text-align: right; ">'+ data[2] + '</td> \
                           <td class="dou-field-Monitor" style="text-align: right; ">'+ data[3] + '</td> \
                           <td class="dou-field-M365" style="text-align: right; ">'+ data[4] + '</td> \
                       </tr>';
